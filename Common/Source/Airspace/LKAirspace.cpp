...
void CAirspace::CalculateScreenPosition(const rectObj &screenbounds_latlon, const AirspaceModeArray& aAirspaceMode, const int iAirspaceBrush[], const RECT& rcDraw, const ScreenProjection& _Proj) {
...
void CAirspaceManager::CalculateScreenPositionsAirspace(const rectObj &screenbounds_latlon, const AirspaceModeArray& aAirspaceMode, const int iAirspaceBrush[], const RECT& rcDraw, const ScreenProjection& _Proj) {
    ScopeLock guard(_csairspaces);
